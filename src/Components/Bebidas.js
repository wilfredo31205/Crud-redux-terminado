...
const Bebidas = ({bebidas}) => {
    ...
    const redireccionarEdicion =  bebidas =>{

        dispatch(obtenerProductoEditar(bebidas))

      history.push(`/listado/editar/${bebidas.id}`)


          //  history.push(`/formularioeditar/${bebidas.id}`)
